<div class="wrap">
    <div class="leftcol">
        ...
        <form method="post" action="<?php echo admin_url('edit.php?post_type=news&page=news-settings') ?>">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" id="show_related" name="show_related" value="1" <?php checked(get_option('hwy_show_related', true)) ?>></td>
                    </tr>
                    <tr>
                        <th><label for="related_news_amount"><?php echo esc_html__('Number of Articles ', 'hello-world-yo') ?></label></th>
                        <td>
                            <select name="related_news_amount" id="related_news_amount"><?php for ($i = 1; $i <= 10; $i++) : ?>
            ...
            <p class="submit">
                <input type="submit" name="submit" class="button button-primary" value="<?php echo esc_attr__('Save Changes', 'hello-world-yo') ?>">
            </p>
        </form>
    </div>
    <div class="rightcol">
        <?php echo __('You can <a href="www.akshayurankar.in" >Check out our website!</a>', 'hello-world-yo'); ?>
    </div>
</div>